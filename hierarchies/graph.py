...
import random
import pandas as pd
from hierarchies.utils import DATASETS, METHODS
from sklearn.cluster import AgglomerativeClustering
from pathlib import Path
import hierarchies.models as models
import torch
import argparse
...
def build_induced_graph(
    ...
    if state_dict:
        centers = get_centers_from_state_dict(state_dict)   # fc weights  num_class * dim
    elif checkpoint:
