...
from hierarchies.utils import fwd, get_directory
...
def wnid_to_synset(wnid):
    ...
    offset = int(wnid[1:])    # e.g. 'n07739125'
    pos = wnid[0]

    try:
        return wn.synset_from_pos_and_offset(wnid[0], offset)   # e.g. Synset('apple.n.01')
    except:
